...
function CharachterSheet({characterData}) {
	...
	const moveLi = useCallback((dragIndex, hoverIndex) => {
    ...
    const renderLi = (li, index) => {
        return (<DraggableLi key={li.id} index={index} id={li.id} stat={stats[index]} moveLi={moveLi} stats={stats}/>);
    };
		...
		<>
			...
			<div className="row">
				<div className="col-5 row">
					<div id="attribute-drag-message" className="col-12 text-glow" style={{display:"none"}}>
				...
				<div className="col-7 row">
					<div className="col-7 secondary-attributes">
						...
						<div className="stat-box">
							<div>Physical: <span id="physical-defense"></span></div>
					...
					<div className="col-5">
						...
						<div className="text-center stat-box stat-title">Infection Points</div>
