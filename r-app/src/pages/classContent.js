      ...
      "backendData":{
         "classAttributes":[
            [
               1,
               "Acrobatic",
               "When jumping, add +1 to the result of the d20 roll."
            ],
            [
               2,
               "Combat Reflexes",
               "Once per round, make two additional attacks of opportunity."
            ],
            [
               4,
               "Resilience",
               "Once per round, if the rogue would be hit by a critical hit or sneak attack, they can make a saving throw with a +4 bonus to resist the critical hit or sneak attack."
            ],
            [
               6,
               "Instinctive Reaction",
               "1 Turn Cooldown. Make a melee attack against a target in range. If successful, the attack deals extra damage equal to your Dexterity modifier."
            ],
            [
               8,
               "Wyvern Sting",
               "2 Actions. Make two ranged attack actions against a target in range. The second attack automatically hits."
            ],
            [
               10,
               "Disarm",
               "1 Action. Make an attack action against a target in range and force them to drop an item in their possession. The rogue gains possession of this item. This item may not be a weapon and must have a value to at least equal the rogue""s level squared.""],[10,""Duelist""s Step",
               "1 Action. Take an immediate reaction against any target that moves adjacent to you. This counts as a disengage for the movement."
            ]
         ],
         "subClass":[
            [
               ...
               [
                  [
                     1,
                     "Deadly Shuriken",
                     "1d6+Dex damage; +1d6 damage per 2 rogue levels above level 1."
                  ],
                  [
                     3,
                     "Uncanny Dodge",
                     "When attacked by a target in range, the rogue can make a disengage check to take no damage from the attack."
                  ],
                  [
                     5,
                     "Distracting Strike",
                     "2 Actions. Make a melee attack action against a target in range. The target gains a -2 to all attacks this round."
                  ],
                  [
                     7,
                     "Death from Above",
                     "1 Action. Make an attack action against a target in range that deals +2 damage. This attack does not suffer a miss chance from full cover."
                  ],
                  [
                     9,
                     "Smoke Bomb",
                     "1 Action. All creatures in the area must make a Dex saving throw. On a failure, they are blinded and deafened for one round. On a success, they are only blinded for one round."
                  ]
               ]
            ],
            [
               ...
               [
                  [
                     1,
                     "Poison Mastery",
                     "Poisoner"s Kit - any poisons applied to the weapon last 4 times longer."],[3,""Death Strike"","1 Action. Make a melee attack against a target in range. If successful,
                     "the target dies instantly. This attack does not suffer a miss chance from full cover. The target is not allowed a saving throw. This attack deals no damage.""],[5,""Death from Afar"","1 Action. Make a ranged attack against a target in range. If successful,
                     "the target dies instantly. This attack does not suffer a miss chance from full cover. The target is not allowed a saving throw. This attack deals no damage.""],[7,""Riposte"","1 Action. Make a melee attack against a target in range. If successful,
                     "this attack does not suffer a miss chance from full cover. If the attack hits",
                     "the rogue gains advantage on all attack rolls against the target until the end of the rogue""s next turn. This attack deals no damage."
                  ],
                  [
                     9,
                     "Hidden Weapons",
                     "1 Action. Make a ranged attack against a target in range. If successful, the attack deals +5 damage. This attack does not suffer a miss chance from full cover. This attack deals no damage."
                  ]
               ]
            ],
            "wildcards":{
